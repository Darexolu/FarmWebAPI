        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyBankAccounts_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyBankAccounts_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyBankAccounts_AspNetUsers_ModifiedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyContacts_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyContacts_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyContacts_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyContacts_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyDocuments_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyDocuments_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyDocuments_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyDocuments_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyHolidays_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyHolidays_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyHolidays_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyHolidays_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyBankAccounts_CreatedById",
                table: "CompanyBankAccounts",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyBankAccounts_DeletedById",
                table: "CompanyBankAccounts",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyBankAccounts_ModifiedById",
                table: "CompanyBankAccounts",
                column: "ModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyContacts_BranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyContacts_CreatedById",
                table: "CompanyContacts",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyContacts_DeletedById",
                table: "CompanyContacts",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyContacts_ModifiedById",
                table: "CompanyContacts",
                column: "ModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyDocuments_BranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyDocuments_CreatedById",
                table: "CompanyDocuments",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyDocuments_DeletedById",
                table: "CompanyDocuments",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyDocuments_ModifiedById",
                table: "CompanyDocuments",
                column: "ModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyHolidays_BranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyHolidays_DeletedById",
                table: "CompanyHolidays",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyHolidays_ModifiedById",
                table: "CompanyHolidays",
                column: "ModifiedById");
